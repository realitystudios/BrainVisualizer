...
namespace VrGrabber
{
	...
	public class Grabbable : MonoBehaviour 
	{
		...
		List<Grabber> grabbers_ = new List<Grabber>();
		...
		private Vector3 vrWorldPos
		{
			get 
			{
				var vrLocalPos = UnityEngine.XR.InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.CenterEye);
		...
		public int OnGrabbed(Grabber grabber)
		{
		...
		public void OnReleased(Grabber grabber)
		{
			onReleased.Invoke();
		...
		public void OnGrabClicked(Grabber grabber)
		{
